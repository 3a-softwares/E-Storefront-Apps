...
Seller dashboard for managing products and orders built with **React 18**, **Vite**, and **Redux Toolkit**.

## � Documentation

| Document                                                   | Description                          |
| ---------------------------------------------------------- | ------------------------------------ |
| [Architecture](../../docs/apps/seller-app/ARCHITECTURE.md) | Application architecture & structure |
| [API Integration](../../docs/apps/seller-app/API.md)       | API integration guide                |
| [Testing Guide](../../docs/apps/seller-app/TESTING.md)     | Testing strategies & examples        |
