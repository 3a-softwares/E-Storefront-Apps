...
export const SeedDataButton = () => {
    ...
    const handleSeedData = async () => {
        if (!window.confirm('Are you sure you want to seed the database with sample data? This will replace existing data.')) {
            return;
        }
        ...
        <div className="p-6 bg-white rounded-lg shadow">
            ...
            <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded">
                <p className="text-sm text-gray-700 mb-2">
                    <strong>Status:</strong> {statusLoading ? 'Checking...' : isDbEmpty ? '🔴 Empty' : '🟢 Populated'}
                </p>
                {seedStatus?.stats && (
